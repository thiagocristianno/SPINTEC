...
/****** Object:  View [dbo].[TT_INSURANCES_ACTIVITIES_OLD]    Script Date: 19/04/2022 09:51:06 ******/
SET ANSI_NULLS ON
GO
...
*/
ALTER VIEW  [dbo].[TT_INSURANCES_ACTIVITIES_OLD] AS 
SELECT DISTINCT

	
	CONVERT(VARCHAR(50), C.CONVENIOID) + '_' + CONVERT(VARCHAR(50),C.CONVENIOCOD) + '_' + CONVERT(VARCHAR(50), CP.PLANOID) AS INSURANCE_LID,
...
FROM
	...
	INNER JOIN PROCTABELASITENS VLR ON 	VLR.PROCID = P.PROCID 	
	
WHERE 
		VLR.PROCTABID = 607  AND
